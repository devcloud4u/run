...
```bash
curl -sL https://raw.githubusercontent.com/devcloud4u/run/refs/heads/main/zt-install.sh | bash
```

veya

```bash
wget -qO- https://raw.githubusercontent.com/devcloud4u/run/refs/heads/main/zt-install.sh | bash
```
